...
- **Equipo**: cualquier contacto se puede marcar como miembro del equipo, con un perfil ampliado (foto, cargo, departamento, fecha de incorporación con la antigüedad calculada, trayectoria, hitos en una línea de tiempo, redes y enlaces, y estado activo o antiguo miembro). La sección Equipo muestra las tarjetas con buscador y filtros por departamento y estado, y la ficha de cada persona con sus reuniones, notas, disponibilidad y «Buscar hueco con esta persona».
